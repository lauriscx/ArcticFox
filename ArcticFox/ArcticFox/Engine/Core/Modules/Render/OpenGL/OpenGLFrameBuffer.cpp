...
Graphics::OpenGL::OpenGLFrameBuffer::OpenGLFrameBuffer(const FrameBufferSpec & spec) : m_Specs(spec) {
	Invalidate();
}

Graphics::FrameBufferSpec & Graphics::OpenGL::OpenGLFrameBuffer::GetSpecs() {
	return m_Specs;
}

const Graphics::FrameBufferSpec & Graphics::OpenGL::OpenGLFrameBuffer::GetSpecs() const {
	return m_Specs;
}

void Graphics::OpenGL::OpenGLFrameBuffer::Bind() {
	glBindFramebuffer(GL_FRAMEBUFFER, m_FrameBuffer);
}
void Graphics::OpenGL::OpenGLFrameBuffer::Unbind() {
	glBindFramebuffer(GL_FRAMEBUFFER, 0);
}

uint32_t Graphics::OpenGL::OpenGLFrameBuffer::GetColorAttachment0() const {
	return m_ColorAttachment0;
}

uint32_t Graphics::OpenGL::OpenGLFrameBuffer::GetDepthAttachment() const {
...
void Graphics::OpenGL::OpenGLFrameBuffer::Invalidate() {
